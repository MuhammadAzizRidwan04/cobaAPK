...
public class FrameEdt_Dlt_Barang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbVendor = new javax.swing.JComboBox<String>();
        ...
        cbStatus.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[] { "Baru", "Rusak", "Lama" }));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Jenis");

        cbJenis.setModel(new javax.swing.DefaultComboBoxModel<String>(new String[] { "Boleh Dipinjam", "Tidak Boleh Dipinjam" }));
